# Generated by Django 4.2.20 on 2026-07-06 20:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0114_enrollmentverification_requested_by'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('active', 'Active'), ('out_of_orbit', 'Out of Orbit'), ('paused', 'Paused')], db_index=True, default='active', max_length=20),
        ),
        migrations.AlterField(
