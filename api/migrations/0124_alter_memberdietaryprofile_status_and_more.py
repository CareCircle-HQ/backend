# Generated by Django 4.2.20 on 2026-07-08 19:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0123_client_verification_disregarded_at_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('active', 'Active'), ('out_of_orbit', 'Out of Orbit'), ('out_of_range', 'Out of Range'), ('paused', 'Paused'), ('inactive', 'Inactive')], db_index=True, default='active', max_length=20),
        ),
        migrations.AlterField(
