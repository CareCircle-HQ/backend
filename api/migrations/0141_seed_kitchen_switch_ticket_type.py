"""Seed the 'Kitchen Switch' ticket type.
...
DESCRIPTION = (
    "The member needs to be switched to a different kitchen "
    "(e.g. change the kitchen serving their meals / deliveries)."
)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("api", "0140_agent_is_williamsburg_agent"),
    ]
