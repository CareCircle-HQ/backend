...
urlpatterns = [
    ...
    path("data/screening-agents/", DataScreeningAgentsView.as_view(), name="portal-data-screening-agents"),
    ...
    path(
        "medical-conditions/",
        MedicalConditionsListView.as_view(),
        name="portal-medical-conditions",
    ),
    path("medications/", MedicationsListView.as_view(), name="portal-medications"),
